...
EEG = pop_loadset('filename','S02_ACC_ica_clean.set','filepath','/Users/varghesepeter/Downloads/S02/');
[ALLEEG, EEG, CURRENTSET] = eeg_store( ALLEEG, EEG, 0 );
EEG  = pop_artmwppth( EEG , 'Channel',  1:64, 'Flag',  1, 'Threshold',  100, 'Twindow', [ -100 998], 'Windowsize',  200, 'Windowstep',  100 ); % GUI: 24-May-2019 15:54:08
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 1,'gui','off');

t1=[ALLEEG(2).epoch.eventbini];
gt1=t1(find(~[ALLEEG(2).epoch.eventflag]));
S02_ACC_Data=[length(find(gt1==1)), length(find(gt1==2)),length(find(gt1==3))];
save S02_ACC_Data S02_ACC_Data;

ERP = pop_averager( ALLEEG , 'Criterion', 'good', 'DSindex',2, 'ExcludeBoundary', 'on', 'SEM', 'on' );                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
ERP = pop_erpchanoperator( ERP, {'nch1 = ch1 - ( 0.5*ch58 ) Label FP1',...
    'nch2 = ch2 - ( 0.5*ch58 ) Label FPz','nch3 = ch3 - ( 0.5*ch58 ) Label FP2',...
    ...
    'Warning', 'on' );
ERP = pop_savemyerp(ERP, 'erpname', 'S02_ACC', 'filename', 'S02_ACC.erp', 'filepath', '/Users/varghesepeter/Downloads/S02'); 
clear